...
import { IconBrandInstagram,IconBrandGithub,IconBrandGmail,IconBrandLinkedin } from "@tabler/icons-react";
        ...
        <div className="flex flex-col items-center justify-center text-center font-mono mb-6" id="contact" >
            ...
            <span className={divClass}>
                ...
                <div className="flex flex-row gap-5 my-5 items-center justify-center">
                    <a href="https://github.com/0xDevvvvv" target="_blank"><IconBrandGithub className={iconClass}/></a>
                    <a href="https://instagram.com/__dev25__" target="_blank"><IconBrandInstagram className={iconClass}/></a>
                    <a href="mailto:devbhagavan25@gmail.com" target="_blank"><IconBrandGmail className={iconClass}/></a>
